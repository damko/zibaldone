...
class Book extends Eloquent
{
    ...
    public function getCoverThumbFilename()
    {
        return BOOKS_COVER_THUMB_FILENAME;
    }
    ...
    public function getRenderInfo($return_content = false)
    {
        ...
        if ($filesystem->has($this->getCoverThumbFilename())) {
            $return['cover_base64'] = base64_encode(file_get_contents($this->getImagesPath() . '/' . $this->getCoverThumbFilename()));
            $return['cover_type'] = 'custom';
        } else {
            $return['cover_base64'] = base64_encode(file_get_contents('../assets/images/default_cover_thumb.png'));
        }
